...
Isso obriga o código a tratar ambos os cenários em tempo de compilação, prevenindo erros aleatórios no runtime.
...
`git clone https://github.com/anaclaraberga/forms_app.git`
